...
resource::Model::Model(Resource &resource)
	: m_resource{resource}
{}
...
std::shared_ptr<resource::Skeleton> resource::Model::GetSkeleton() const
{
	return Skeleton::Create(*const_cast<Model*>(this)->GetData());
}
